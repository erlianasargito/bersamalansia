          ...
          <div className="w-auto">
            <ul className="items-center flex">
              <li className="ml-6 block md:hidden">
                <button
                  id="menu-toggler"
                  className={["relative flex z-50 items-center justify-center w-8 h-8 focus:outline-none", theme === "white" ? "text-black md:text-white" : "text-white md:text-black"].join(" ")}
                >
                  <svg
